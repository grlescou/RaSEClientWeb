...
app.factory('UserSericeAuth',['$cookieStore','$http','SessionCookies',function($cookieStore,$http,SessionCookies){
       ...
       $http.post(apiServer.getURLAdministrateur()+"auth",auth,conf)
        .success(function (data, status, headers, conf)
        {
          ...
          if(data.success === true){
            ...
            if(data.t.actif && data.t.role.privilege === "Administrateur")
            {
            Rdata.success = true;
      ...
      UserService.logout = function (){
           ...
           Rdata.User.privilege = "public";
           Rdata.User.typeAdmin = "";
           SessionCookies.removeSession("Rase-admin");
           SessionCookies.removeCookie("Rase-admin");
        ...
        UserService.refreshSession = function (callback){
            ...
            Rdata.message = "";
             ...
             var  UserSession = angular.fromJson( SessionCookies.getSession("Rase-admin"));
             console.log(UserSession);
             if(UserSession === null)
             {
                var  UserCookie =  angular.fromJson(SessionCookies.getCookie("Rase-admin"));
